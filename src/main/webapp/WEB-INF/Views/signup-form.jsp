		...
		<div class="row">
			<div class="offset-3 col-6 my-5">
				...
				<form:form action="register" modelAttribute="student" cssClass="form-group" >
					...
					<form:password path="age" class="form-control mb-2" placeholder="Enter your age" />
					
					<form:label path="dob">Date of Birth:</form:label>
					<form:input path="dob" type = "date" cssClass="form-control mb-2" placeholder= "Select date of birth"/>
					
					<form:label path="gender">Gender</form:label>
					<form:radiobutton path="gender" cssClass="m-2"  value="M" label="Male" checked="checked" />
					...
					<input type="checkbox" class="my-3" value="true" />
					<label>Terms and Conditions:</label>
					<br>
					
					<form:button name="Submit" value="Submit" class="btn btn-primary">Sign Up</form:button>
